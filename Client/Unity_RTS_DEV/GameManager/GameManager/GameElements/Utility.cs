...
namespace GameManager.GameElements
{
	...
	public class Utility
	{
		...
		{
			return new Vector3Int(gridNbr / GameManager.Instance.MapSize.y, gridNbr % GameManager.Instance.MapSize.y, 0);
		}
		...
		{
			return position.x * GameManager.Instance.MapSize.y + position.y;
		}
		...
		{
			return !(gridPosition.x < 0 || gridPosition.x >= GameManager.Instance.MapSize.x
					|| gridPosition.y < 0 || gridPosition.y >= GameManager.Instance.MapSize.y);
		}
